...
export default class Landing extends BaseComponent {
  constructor(props) {
    ...
    this.ppVideo     = this.ppVideo.bind(this)
    this.muVideo     = this.muVideo.bind(this)
  }
    ...
    return (
      <div className="l-container">
        ...
        {/* <Container fluid className="p-0 top w-100">
          <ReactPlayer className="vplayer" light={require('./img/banner.jpg')} urls={'https://www.youtube.com/watch?v=yKx__UxDIbQ'} url={'./video/landing.mp4'} playing={true}/>
        </Container> */}
        ...
        <Container fluid className="p-0 top w-100">
          ...
          <div className="action-toolbar">
            <div className="float-left">
              {
                this.state.video.pus
                ?<FaPlayCircle onClick={this.ppVideo} />
                :<FaPauseCircle onClick={this.ppVideo} />
              }
            </div>

            <div className="float-right">
            {
                !this.state.video.mut
                ?<FaVolumeMute onClick={this.muVideo}/>
                :<FaVolumeUp onClick={this.muVideo}/>
            }
            </div>
          </div>
