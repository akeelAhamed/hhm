        ...
        <div className="home-bg-prod mx-3" style={{backgroundImage: 'url('+this.getImage(product.allimages, 'back_ground')+')'}}>
          <div className="home-bg-2_text">
            ...
            <img className="img-fluid w-100 d-sm-none" alt="banner" src={this.state._3d[0].img} />
              ...
              alt="logo"
            />
            <Link className="btn btn-primaryhomenew" to={"/item/"+product.slug}>Buy now</Link>
          </div>
        </div>
          ...
          <Container fluid>
            <Row className="_3d">
              ...
              <Col md="7">
                ...
                <div dangerouslySetInnerHTML={{ __html:'<b>BENEFITS OF P.U.R.E SMOKE THERAPY</b><br/>Induces Anti-Inflammatory and Antioxidant effects<br/>Heals Chronic Respiratory tract disorders<br/> Breaks addiction to induce mental tranquillity<br/>Energies seven energy centers<br/>Eliminates free radicals<br/> Generating neuro – modulators to enhance memory<br/>Purifies air by killing bacteria' }} /><br />
